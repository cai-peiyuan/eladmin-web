...
export default {
  ...
  mounted() {
    ...
    document.getElementById('mapStyleEditorIframe').src = Config.mspMapSpriteEditorUrl + '?editorConfig=mspToolMapStyleEditor&layer=3202069833%7E0#10.66/39.9348/116.3695'
